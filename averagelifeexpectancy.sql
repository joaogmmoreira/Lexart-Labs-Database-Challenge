...
CREATE TABLE `averagelifeexpectancy` (
  `LifeProm` bigint DEFAULT NULL,
  `Region` enum('Asia','Europe','North America','Africa','Oceania','Antarctica','South America') NOT NULL DEFAULT 'Asia'
...
INSERT INTO `averagelifeexpectancy` VALUES (70,'South America'),(72,'North America'),(67,'Asia');
...
-- Dump completed on 2023-07-21 12:50:29
